...
if [ "$MODE" = "full" ] || [ "$MODE" = "list" ]; then
  ...
  install_skill "PostHog (umbrella)" "posthog/posthog-for-claude"
  ...
  # Selected sub-skills from anthropics/skills — useful for SaaS work
  install_skill "Anthropic skill creator" "https://github.com/anthropics/skills" "--skill" "skill-creator"
  install_skill "PDF generation" "https://github.com/anthropics/skills" "--skill" "pdf"
